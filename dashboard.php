                        ...
                        <div class="row">
                                <div class="col-md-4">
                                        <div class="card text-white bg-primary mb-3" style="max-width:18rem;">
                                            <div class="card-header">Total de equipamentos</div>
                                                <div class="card-body">
                                                    <h5 class="card-title" style="text-align:center; font-size: 40px">
                                                        <?php
                                                        
                                                        $conexao = mysqli_connect('localhost', 'root', '', 'projeto_ibge');
                                                        $sql = "SELECT count(ID_equipamento) as quantidade from equipamento";
                                ...
                                <div class="col-md-4">
                                        <div class="card text-white bg-primary mb-3" style="max-width:18rem;">
                                            <div class="card-header">Total de servidores</div>
                                                <div class="card-body">
                                                    <h5 class="card-title" style="text-align:center; font-size: 40px">
                                                        <?php
                                                        
                                                        $conexao = mysqli_connect('localhost', 'root', '', 'projeto_ibge');
                                                        $sql = "SELECT count(ID_servidor) as quantidade from servidor";
                                                        $consulta = mysqli_query($conexao, $sql);
                                                        $dados = mysqli_fetch_array($consulta);
                                                        echo $dados['quantidade'];
                                                        ?>
                                                    <span style="font-size: 10px"> / cadastrados</span></h5>
                                                </div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                        <div class="card text-white bg-danger mb-3" style="max-width:18rem;">
                                            <div class="card-header">Equipamentos sem status</div>
                                                <div class="card-body">
                                                    <h5 class="card-title" style="text-align:center; font-size: 40px">
                                                        <?php
                                                        
                                                        $conexao = mysqli_connect('localhost', 'root', '', 'projeto_ibge');
                                                        $sql = "SELECT count(ID_equipamento) as quantidade from equipamento WHERE ID_status = 1";
                                                        $consulta = mysqli_query($conexao, $sql);
                                                        $dados = mysqli_fetch_array($consulta);
                                                        echo $dados['quantidade'];
                                                        ?>
